...
<template>
  <div id="hareIMGContainer">
    <a href="https://github.com/Nyasper/Proyecto-1---app-Notas" target="_blank">
      <img src="/Hare_Portrait.webp" alt="hare-portrait">
      <p>GITHUB</p>
    </a>   
...
#hareIMGContainer > a > p{
  text-align: center;
  font-size: 1.6em;
  margin-top: 5px;
}

#hareIMGContainer img {
  height: 560px;
